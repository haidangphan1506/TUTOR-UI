...
/** Google "G" mark — official brand colors (blue, green, yellow, red). */
...
/** Apple logo — monochrome (black on light, white on dark) per typical lockup usage. */
export function AppleBrandIcon({
  ...
  return (
    <svg
      ...
      viewBox="0 0 384 512"
      aria-hidden
      className={cn("size-4 shrink-0 fill-black dark:fill-white", className)}
      {...props}
    >
...
/** Facebook logo — rounded square with white "f" on blue background. */
